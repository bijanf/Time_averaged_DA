...
model_config(){
    ...
    addi_info="${addi_info}__n_obs-${n_obs}"
    exp_dir(){ echo "$STORE/$model/$par_set/${exp_name}${addi_info}";}

    # addi_info="__m${ensemble_size}_coupled_analysis-${coupled_analysis}"
}
...
default_config(){
    ...
    Taver_steps=30; product $dt $Taver_steps Taver_length
    export Taver_length
	...
	narrow)
	    ...
	    ;;
        *) error "Unknown resp_window_size $resp_window_size";;
    esac
    ...
    export comp_localization="no" # vslite obs relate to both components then
    #                               then comp_localization loses sense here
    ...
    Taver_range="big"
    # Taver_span[mid]="ispan(1,101,10)*$dt"
    ...
    #span[SNR]="fspan(0.1,2.0,10)"
    span[SNR]="fspan(0.1,10.0,30)"
...
#=======================================================================
# @brief L96_2s dynamical model configurations
#=======================================================================
set_pars(){

    case "$par_set" in
        "c0.1_h1.0-b1.0")
            c="0.1"; h="1.0"; b="1.0";  infl_enkf="1.0";;
        "c0.1_h1.0-b0.5")
            c="0.1"; h="1.0"; b="0.5";  infl_enkf="1.0";;
        "c0.1_h1.0-b4.0")
            c="0.1"; h="1.0"; b="4.0";  infl_enkf="1.0";;
        "c0.1_h0.5-b1.0")
            c="0.1"; h="0.5"; b="1.0";  infl_enkf="1.0";;
        "c0.1_h2.0-b1.0")
            c="0.1"; h="2.0"; b="1.0";  infl_enkf="1.0";;
        "c0.1_h2.0-b4.0")
            c="0.1"; h="2.0"; b="4.0";  infl_enkf="1.0";;
        "c0.1_h4.0-b1.0")
            c="0.1"; h="4.0"; b="1.0";  infl_enkf="1.0";;
        "c0.1_h4.0-b4.0")
            c="0.1"; h="4.0"; b="4.0";  infl_enkf="1.0";;
        "c0.5-h4.0-b4.0")
            c="0.5"; h="4.0"; b="4.0";  infl_enkf="1.0";;
        "c0.2-h4.0-b4.0")
            c="0.2"; h="4.0"; b="4.0";  infl_enkf="1.0";;
        "c0.2-h1.0-b1.0")
            c="0.2"; h="1.0"; b="1.0";  infl_enkf="1.0";;
        "c0.5_h4.0_b-4.0")
            c="0.5"; h="4.0"; b="-4.0"; infl_enkf="1.0";;
        "c0.4_h4.0_b-4.0")
            c="0.4"; h="4.0"; b="-4.0"; infl_enkf="1.0";;
        "c0.3_h4.0_b-4.0")
            c="0.3"; h="4.0"; b="-4.0";  infl_enkf="1.0";;
  
        "c1.0_h0.3_b1.0")
            c="1.0"; h="0.3"; b="1.0" ;  infl_enkf="1.0";;
        "c0.5_h1.0_b1.0")
            c="0.5"; h="1.0"; b="1.0";  infl_enkf="1.0";;
        *) error "Unknown par_set $par_set";;
    esac

    export force="8.0"  # Comp. 1 forcing term
